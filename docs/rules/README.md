...
| [Moq1203](./Moq1203.md) | Correctness   | InSequence setup should be properly configured                                          | [InSequenceSetupShouldBeProperlyConfiguredAnalyzer.cs](../../src/Analyzers/InSequenceSetupShouldBeProperlyConfiguredAnalyzer.cs) |
