...
[InProcess]
[MemoryDiagnoser]
public class Moq1800Benchmarks
{
...
{{
    ...
    {{
        ...
        mock.SetupAdd(x => x.TestEvent += It.IsAny<EventHandler<int>>()); // Wrong handler type - should trigger diagnostic
        _ = mock.Object.TestEvent;
    }}
}}
"));
        }
        ...
        (BaselineCompilation, TestCompilation) =
            ...
            .CreateAsync<EventHandlerSignatureMismatchAnalyzer>(sources.ToArray())
            .GetAwaiter()
            .GetResult();
    }

    [Benchmark]
    public async Task Moq1800WithDiagnostics()
    {
    ...
    public async Task Moq1800Baseline()
    {
        ImmutableArray<Diagnostic> diagnostics =
