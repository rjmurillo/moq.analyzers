...
[InProcess]
[MemoryDiagnoser]
public class Moq1203EventSetupHandlerBenchmarks
{
...
{{
    ...
    {{
        ...
        // This should trigger Moq1203 - wrong handler type
        mock.SetupAdd(x => x.StringEvent += It.IsAny<Action<int>>());
...
"));
        ...
        (BaselineCompilation, TestCompilation) =
            BenchmarkCSharpCompilationFactory.CreateAsync<EventSetupHandlerShouldMatchEventTypeAnalyzer>(sources.ToArray(), referenceAssemblies)
            .GetAwaiter()
            .GetResult();
    }
