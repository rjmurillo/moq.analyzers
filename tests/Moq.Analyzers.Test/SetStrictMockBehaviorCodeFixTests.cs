using Verifier = Moq.Analyzers.Test.Helpers.CodeFixVerifier<Moq.Analyzers.SetStrictMockBehaviorAnalyzer, Moq.CodeFixes.SetStrictMockBehaviorFixer>;

namespace Moq.Analyzers.Test;

public class SetStrictMockBehaviorCodeFixTests
{
    private readonly ITestOutputHelper _output;

    public SetStrictMockBehaviorCodeFixTests(ITestOutputHelper output)
    {
        _output = output;
    }
